...
public class BMBlocks {
    ...
    public static final RegistryObject<Block> MID_TERM_ORE = BLOCKS.register("mid_term_ore", () -> new BMOreBlock(5, 7, AbstractBlock.Properties.of(Material.STONE).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(50, 1200)));
    public static final RegistryObject<Block> OBSIDIAN_MID_TERM_ORE = BLOCKS.register("obsidian_mid_term_ore", () -> new BMOreBlock(5, 7, AbstractBlock.Properties.of(Material.STONE).harvestLevel(3).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE).strength(100, 2400)));
    ...
    public static final RegistryObject<Block> DEVIL_CONCRETE = BLOCKS.register("devil_concrete", () -> new Block(AbstractBlock.Properties.copy(Blocks.RED_CONCRETE)));
    public static final RegistryObject<Block> DEVIL_CONCRETE_POWDER = BLOCKS.register("devil_concrete_powder", () -> new ConcretePowderBlock(DEVIL_CONCRETE.get(), AbstractBlock.Properties.copy(Blocks.RED_CONCRETE_POWDER)));
    public static final RegistryObject<Block> DEVIL_TERRACOTTA = BLOCKS.register("devil_terracotta", () -> new Block(AbstractBlock.Properties.copy(Blocks.RED_TERRACOTTA)));
    public static final RegistryObject<Block> DEVIL_GLAZED_TERRACOTTA = BLOCKS.register("devil_glazed_terracotta", () -> new GlazedTerracottaBlock(AbstractBlock.Properties.copy(Blocks.RED_GLAZED_TERRACOTTA)));
    public static final RegistryObject<Block> DEVIL_WOOL = BLOCKS.register("devil_wool", () -> new Block(AbstractBlock.Properties.copy(Blocks.RED_WOOL)));
    public static final RegistryObject<Block> DEVIL_CARPET = BLOCKS.register("devil_carpet", () -> new CarpetBlock(DyeColor.RED, AbstractBlock.Properties.copy(Blocks.RED_CARPET)));
    public static final RegistryObject<Block> DEVIL_STAINED_GLASS = BLOCKS.register("devil_stained_glass", () -> new CustomBeamGlassBlock(0xFF0E07, AbstractBlock.Properties.copy(Blocks.RED_STAINED_GLASS)));
    public static final RegistryObject<Block> DEVIL_STAINED_GLASS_PANE = BLOCKS.register("devil_stained_glass_pane", () -> new CustomBeamGlassPaneBlock(0xFF0E07, AbstractBlock.Properties.copy(Blocks.RED_STAINED_GLASS_PANE)));
    ...
    public static final RegistryObject<Block> AMARACAMEL_BATTER_BAG = BLOCKS.register("amaracamel_batter_bag", () -> new BagBlock(AbstractBlock.Properties.of(Material.WOOL, MaterialColor.COLOR_ORANGE).strength(0.8F).sound(SoundType.WOOL)));
    public static final RegistryObject<Block> BOOT_PACK = BLOCKS.register("boot_pack", () -> new BagBlock(AbstractBlock.Properties.of(Material.WOOL, MaterialColor.COLOR_RED).strength(0.8F).sound(SoundType.WOOL)));
