...
public class BMBlocks {
    ...
    public static final RegistryObject<FlowingFluidBlock> SLEEPISHWATER = BLOCKS.register("sleepishwater", () -> new FlowingFluidBlock(BMFluids.SLEEPISHWATER, AbstractBlock.Properties.create(Material.WATER, MaterialColor.PURPLE).doesNotBlockMovement().hardnessAndResistance(100).noDrops()));
    ...
    public static final RegistryObject<Block> QUEEN_SOPHIE_PET_RELIC = BLOCKS.register("queen_sophie_pet_relic", () -> new QueenLucyPetRelicBlock(AbstractBlock.Properties.from(Blocks.GOLD_BLOCK).harvestLevel(2).setLightLevel(state -> 5)));
