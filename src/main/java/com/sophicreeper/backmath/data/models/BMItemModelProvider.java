...
public class BMItemModelProvider extends BMItemModelModels {
    ...
    protected void registerModels() {
        ...
        fruitLeaves("guarana_oak_leaves", "guaranas", mcLoc("block/oak_leaves"));
        fruitLeaves("mango_oak_leaves", "mangoes", mcLoc("block/oak_leaves"));
        fruitLeaves("mangaed_mango_oak_leaves", "mangaed_mangoes", mcLoc("block/oak_leaves"));
        block("grape_vine_leaves");
        fruitLeaves("lemon_oak_leaves", "lemons", mcLoc("block/oak_leaves"));
        block("pineapple_oak_leaves");
        fruitLeaves("orange_oak_leaves", "oranges", mcLoc("block/oak_leaves"));
        fruitLeaves("banana_jungle_leaves", "bananas", mcLoc("block/jungle_leaves"));
        fruitLeaves("aljame_birch_leaves", "aljames", mcLoc("block/birch_leaves"));
