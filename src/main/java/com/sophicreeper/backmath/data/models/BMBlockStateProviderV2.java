...
public class BMBlockStateProviderV2 extends BMBlockStateModels {
    ...
    protected void registerStatesAndModels() {
        ...
        fruitLeaves(GUARANA_OAK_LEAVES.get(), modLoc("block/oak_fruit_leaves"), modLoc("block/guarana_fruit_leaves"));
        fruitLeaves(MANGO_OAK_LEAVES.get(), modLoc("block/oak_fruit_leaves"), modLoc("block/mango_fruit_leaves"));
        fruitLeaves(MANGAED_MANGO_OAK_LEAVES.get(), modLoc("block/oak_fruit_leaves"), modLoc("block/mangaed_mango_fruit_leaves"));
        fruitLeaves(GRAPE_VINE_LEAVES.get(), modLoc("block/spruce_fruit_leaves"), modLoc("block/grape_fruit_leaves"));
        fruitLeaves(ALJAME_BIRCH_LEAVES.get(), modLoc("block/birch_fruit_leaves"), modLoc("block/aljame_fruit_leaves"));
        fruitLeaves(PINEAPPLE_OAK_LEAVES.get(), modLoc("block/oak_fruit_leaves"), modLoc("block/pineapple_fruit_leaves"));
        fruitLeaves(LEMON_OAK_LEAVES.get(), modLoc("block/oak_fruit_leaves"), modLoc("block/lemon_fruit_leaves"));
        fruitLeaves(ORANGE_OAK_LEAVES.get(), modLoc("block/oak_fruit_leaves"), modLoc("block/orange_fruit_leaves"));
        fruitLeaves(BANANA_JUNGLE_LEAVES.get(), modLoc("block/jungle_fruit_leaves"), modLoc("block/banana_fruit_leaves"));
