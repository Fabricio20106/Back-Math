...
public class BMItemTagsProvider extends ItemTagsProvider {
    ...
    protected void registerTags() {
        ...
        this.getOrCreateBuilder(BMTags.Items.JABUTICABA_LOGS).add(AxolotlTest.JABUTICABA_LOG.get()).add(AxolotlTest.JABUTICABA_WOOD.get()).add(AxolotlTest.JABUTICABA_LOG.get()).add(AxolotlTest.JABUTICABA_WOOD.get());
