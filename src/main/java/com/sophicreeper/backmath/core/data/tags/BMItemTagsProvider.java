...
public class BMItemTagsProvider extends ItemTagsProvider {
    public BMItemTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider, CompletableFuture<TagsProvider.TagLookup<Block>> blockTagsLookup, ExistingFileHelper fileHelper) {
        super(output, provider, blockTagsLookup, BackMath.MOD_ID, fileHelper);
    }
    ...
    public void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BMTags.Items.INGOTS_MID_HILLARY).add(AxolotlTest.MID_HILLARY_INGOT.get());
        ...
        // this.tag(BMTags.Items.ORES_ALJAMEED).add(AxolotlTest.RAW_ALJAMEED.get()).add(AxolotlTest.ALJAMEED_ORE.get());
        // this.tag(BMTags.Items.ORES_MOONERING).add(AxolotlTest.RAW_MOONER.get()).add(AxolotlTest.MOONERING_ORE.get());
        ...
        this.tag(BMTags.Items.SINGULARITIES).addTag(BMTags.Items.SINGULARITIES_FRUTIFERY).addTag(BMTags.Items.SINGULARITIES_MEATY).addTag(BMTags.Items.SINGULARITIES_VEGETABLY).addTag(BMTags.Items.SINGULARITIES_EMOTIONAL).addTag(BMTags.Items.SINGULARITIES_CHRISTIANITY)
        ...
        this.tag(BMTags.Items.NUGGETS_MID_HILLARY).add(AxolotlTest.MID_HILLARY_NUGGET.get());
        ...
        // Rods
        this.tag(Tags.Items.RODS).addTag(BMTags.Items.RODS_ALJANWOOD).addTag(BMTags.Items.RODS_ALJANCAP).addTag(BMTags.Items.RODS_INSOMNIAN).addTag(BMTags.Items.RODS_ALJAMEED).addTag(BMTags.Items.RODS_GUAVA).addTag(BMTags.Items.RODS_AVONDALIC_WILLOW)
        ...
        this.tag(Tags.Items.GLASS).addTag(BMTags.Items.GLASS_DEVIL);
        this.tag(Tags.Items.GLASS_PANES).addTag(BMTags.Items.GLASS_PANES_DEVIL);
        ...
        this.tag(Tags.Items.STAINED_GLASS).add(AxolotlTest.DEVIL_STAINED_GLASS.get());
        this.tag(Tags.Items.STAINED_GLASS_PANES).add(AxolotlTest.DEVIL_STAINED_GLASS_PANE.get());
        ...
        this.tag(BMTags.Items.JABUTICABA_LOGS).add(AxolotlTest.JABUTICABA_LOG.get()).add(AxolotlTest.JABUTICABA_WOOD.get()).add(AxolotlTest.JABUTICABA_LOG.get()).add(AxolotlTest.JABUTICABA_WOOD.get());
        ...
        this.tag(BMTags.Items.BACK_GUIDE_RECIPE_ACCEPTABLES).add(AxolotlTest.GUARANA.get()).add(AxolotlTest.MANGO.get()).add(AxolotlTest.MANGAED_MANGO.get())
        ...
        this.tag(BMTags.Items.MATERIALS_HARDENED_AMARACAMEL).addTag(BMTags.Items.INGOTS_HARDENED_AMARACAMEL).add(AxolotlTest.HARDENED_AMARACAMEL_BATTER.get());
        this.tag(BMTags.Items.MATERIALS).addTag(BMTags.Items.MATERIALS_HARDENED_AMARACAMEL);
        ...
        this.tag(BMTags.Items.JAMS).add(AxolotlTest.GUARANA_JAM.get()).add(AxolotlTest.MANGO_JAM.get()).add(AxolotlTest.MANGA_JAM.get()).add(AxolotlTest.GRAPE_JAM.get())
