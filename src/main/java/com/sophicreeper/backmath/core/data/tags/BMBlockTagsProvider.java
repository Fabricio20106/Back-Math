...
public class BMBlockTagsProvider extends BlockTagsProvider {
    public BMBlockTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> providerLookup, ExistingFileHelper fileHelper) {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.GUARDED_BY_PIGLINS).add(BMBlocks.CRYSTALLINE_BIRCH_LEAVES.get()).add(BMBlocks.CRYSTALLINE_CRYSTALLIZER.get()).add(BMBlocks.QUEEN_SOPHIE_RELIC
        ...
        this.tag(BMTags.Blocks.JABUTICABA_LOGS).add(BMBlocks.JABUTICABA_LOG.get()).add(BMBlocks.JABUTICABA_WOOD.get()).add(BMBlocks.JABUTICABA_LOG.get()).add(BMBlocks.JABUTICABA_WOOD.get());
