...
public class BMStructures {
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(SOPHIE_TOWER.get(),
                new StructureSeparationSettings(10,5, 1073741823),
                true);
        setupMapSpacingAndLand(FABRICIO_HIDEOUT_DUNGEON.get(),
                new StructureSeparationSettings(15, 10, 27482834),
                false);
    }
