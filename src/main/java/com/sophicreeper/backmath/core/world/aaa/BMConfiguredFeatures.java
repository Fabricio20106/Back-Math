...
public class BMConfiguredFeatures {
    ...
    public static final RuleTest OBSIDIAN_ORE_REPLACEABLES = new BlockMatchTest(Blocks.OBSIDIAN);
    ...
    public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES = DeferredRegister.create(Registries.CONFIGURED_FEATURE, BackMath.MOD_ID);

    public static final Supplier<List<OreConfiguration.TargetBlockState>> DEVIL_ORE_TARGET_LIST = Suppliers.memoize(() -> List.of(
    ...
    public static final Supplier<List<OreConfiguration.TargetBlockState>> ANGELIC_ORE_TARGET_LIST = Suppliers.memoize(() -> List.of(
    ...
    public static final Supplier<List<OreConfiguration.TargetBlockState>> CRYSTALLINE_ANGELIC_ORE_TARGET_LIST = Suppliers.memoize(() -> List.of(
    ...
    public static final Supplier<List<OreConfiguration.TargetBlockState>> MID_TERM_ORE_TARGET_LIST = Suppliers.memoize(() -> List.of(
            OreConfiguration.target(END_ORE_REPLACEABLES, BMBlocks.MID_TERM_ORE.get().defaultBlockState()),
            OreConfiguration.target(OBSIDIAN_ORE_REPLACEABLES, BMBlocks.OBSIDIAN_MID_TERM_ORE.get().defaultBlockState())));

    public static final RegistryObject<ConfiguredFeature<?, ?>> DEVIL_ORE_VEIN = CONFIGURED_FEATURES.register("devil_ore_vein", () ->
            new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(DEVIL_ORE_TARGET_LIST.get(), 6)));

    public static final RegistryObject<ConfiguredFeature<?, ?>> ANGELIC_ORE_VEIN = CONFIGURED_FEATURES.register("angelic_ore_vein", () ->
            new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(ANGELIC_ORE_TARGET_LIST.get(), 6)));

    public static final RegistryObject<ConfiguredFeature<?, ?>> ABUNDANT_ANGELIC_ORE_VEIN = CONFIGURED_FEATURES.register("abundant_angelic_ore_vein", () ->
            new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(ANGELIC_ORE_TARGET_LIST.get(), 9)));

    public static final RegistryObject<ConfiguredFeature<?, ?>> CRYSTALLINE_ANGELIC_ORE_VEIN = CONFIGURED_FEATURES.register("crystalline_angelic_ore_vein", () ->
            new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(CRYSTALLINE_ANGELIC_ORE_TARGET_LIST.get(), 5)));

    public static final RegistryObject<ConfiguredFeature<?, ?>> MID_TERM_ORE_VEIN = CONFIGURED_FEATURES.register("mid_term_ore_vein", () ->
            new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(MID_TERM_ORE_TARGET_LIST.get(), 3)));*/
