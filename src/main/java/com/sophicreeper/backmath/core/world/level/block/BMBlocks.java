...
public class BMBlocks {
    ...
    public static final RegistryObject<LiquidBlock> MILKLLARY = BLOCKS.register("milklary", () -> new LiquidBlock(BMFluids.MILKLLARY, BlockBehaviour.Properties.copy(Blocks.WATER)));
    public static final RegistryObject<LiquidBlock> LIQUID_ALJAME = BLOCKS.register("liquid_aljame", () -> new LiquidBlock(BMFluids.LIQUID_ALJAME, BlockBehaviour.Properties.copy(Blocks.WATER).mapColor(MapColor.CLAY)));
    public static final RegistryObject<LiquidBlock> LIQUID_MANGA = BLOCKS.register("liquid_manga", () -> new LiquidBlock(BMFluids.LIQUID_MANGA, BlockBehaviour.Properties.copy(Blocks.WATER).mapColor(MapColor.TERRACOTTA_BLUE)));
    public static final RegistryObject<LiquidBlock> LIQUEFIED_MONSTER = BLOCKS.register("liquefied_monster", () -> new LiquidBlock(BMFluids.LIQUEFIED_MONSTER, BlockBehaviour.Properties.copy(Blocks.WATER).mapColor(MapColor.COLOR_GREEN)));
    public static final RegistryObject<LiquidBlock> SLEEPISHWATER = BLOCKS.register("sleepishwater", () -> new LiquidBlock(BMFluids.SLEEPISHWATER, BlockBehaviour.Properties.copy(Blocks.WATER).mapColor(MapColor.COLOR_PURPLE)));
    ...
    public static final RegistryObject<Block> JABUTICABA_SAPLING = BLOCKS.register("jabuticaba_sapling", () -> new SaplingBlock(new JabuticabeiraGrower(), BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING)));
