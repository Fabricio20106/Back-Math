...
public class AxolotlTest {
    ...
    public static final RegistryObject<Item> OBSIDITERM_BRICKS = ITEMS.register("obsiditerm_bricks", () -> new BlockItem(BMBlocks.OBSIDITERM_BRICKS.get(), new Item.Properties().group(BMBlockTab.TAB).isImmuneToFire().rarity(Rarity.RARE)));
    public static final RegistryObject<Item> OBSIDITERM_BRICK_STAIRS = ITEMS.register("obsiditerm_brick_stairs", () -> new BlockItem(BMBlocks.OBSIDITERM_BRICK_STAIRS.get(), new Item.Properties().group(BMBlockTab.TAB).isImmuneToFire().rarity(Rarity.RARE)));
    public static final RegistryObject<Item> OBSIDITERM_BRICK_SLAB = ITEMS.register("obsiditerm_brick_slab", () -> new BlockItem(BMBlocks.OBSIDITERM_BRICK_SLAB.get(), new Item.Properties().group(BMBlockTab.TAB).isImmuneToFire().rarity(Rarity.RARE)));
    public static final RegistryObject<Item> OBSIDITERM_BRICK_WALL = ITEMS.register("obsiditerm_brick_wall", () -> new BlockItem(BMBlocks.OBSIDITERM_BRICK_WALL.get(), new Item.Properties().group(BMBlockTab.TAB).isImmuneToFire().rarity(Rarity.RARE)));
