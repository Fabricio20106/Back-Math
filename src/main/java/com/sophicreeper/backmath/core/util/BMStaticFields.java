...
public class BMStaticFields {
    public static final BMArmors CAT_TIARA_ARMOR = new BMArmors.CatTiara();
    public static final BMArmors DOG_TIARA_ARMOR = new BMArmors.DogTiara();
    public static final BMArmors CANDY_YELLOW_TURTLE = new BMArmors.CandyYellowTurtle();
    public static final BMArmors CANDY_PINK_TURTLE = new BMArmors.CandyPinkTurtle();
    public static final BMArmors ALJAMIC_BONE = new BMArmors.AljamicBone();
    ...
    public static final BMArmors MID_TERM_ARMOR = new BMArmors.MidTerm();
    public static final BMArmors ARCHER_LUCIA_ARMOR = new BMArmors.ArcherLuciaVest();
    public static final BMArmors YELLOW_KARATE_BAND_ARMOR = new BMArmors.YellowKarateHeadband();
    public static final BMArmors BAKUGOU_ARMOR = new BMArmors.Bakugou();
    public static final BMArmors INSOMNIA_SOPHIE_SLEEPWEAR = new BMArmors.InsomniaSophieSleepwear();
    public static final BMArmors HARDENED_AMARACAMEL_ARMOR = new BMArmors.HardenedAmaracamel();
    public static final BMArmors OBSIDIAN_INFUSED_MID_TERM_ARMOR = new BMArmors.ObsidianInfusedMidTerm();
    ...
    public static final BMArmors ARCHER_FABRICIO_ARMOR = new BMArmors.ArcherFabricioVest();
    ...
    public static final BMTools MECH_MECH_SET = new BMTools.MechMech();
