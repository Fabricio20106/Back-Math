...
@OnlyIn(Dist.CLIENT)
public class WandererSophieHeadBlockEntityRenderer extends TileEntityRenderer<WandererSophieHeadBlockEntity> {
    public WandererSophieHeadBlockEntityRenderer(TileEntityRendererDispatcher dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(WandererSophieHeadBlockEntity blockEntity, float partialTicks, MatrixStack stack, IRenderTypeBuffer buffer, int combinedLight, int combinedOverlay) {
