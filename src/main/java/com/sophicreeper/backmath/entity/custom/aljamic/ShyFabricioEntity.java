...
public class ShyFabricioEntity extends AljamicMemberEntity {
    public ShyFabricioEntity(EntityType<ShyFabricioEntity> type, World world) {
        super(type, world);
        this.maxUpStep = 1;
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new TemptGoal(this, 1.1, Ingredient.of(BMItemTags.SHY_FABRICIO_TEMPT_ITEMS), true));
        this.goalSelector.addGoal(2, new AvoidEntityGoal<>(this, LivingEntity.class, 24, 1.6, 2.6, livEntity -> !livEntity.getType().is(BMEntityTypeTags.SHY_FABRICIO_FRIENDLIES)));
        ...
        this.goalSelector.addGoal(4, new LookAtGoal(this, AljamicMemberEntity.class, 6));
