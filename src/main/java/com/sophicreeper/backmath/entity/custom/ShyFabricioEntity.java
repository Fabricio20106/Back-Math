...
public class ShyFabricioEntity extends CreatureEntity {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new TemptGoal(this, 1.1D, Ingredient.of(BMItemTags.SHY_FABRICIO_TEMPT_ITEMS), true));
        this.goalSelector.addGoal(2, new AvoidEntityGoal<>(this, LivingEntity.class, 24, 1.6D, 2.6D, (livEntity) -> !(livEntity.getType().is(BMEntityTypeTags.SHY_FABRICIO_FRIENDLIES))));
        ...
        this.goalSelector.addGoal(4, new LookAtGoal(this, ShyFabricioEntity.class, 6));
