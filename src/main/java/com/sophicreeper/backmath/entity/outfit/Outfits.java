...
public class Outfits {
    ...
    public static final OutfitDefinition CRATE = new OutfitDefinition(BackMath.backMath("crate"), null, new OutfitSlot(texture("crate_chest")), null, null);
    public static final OutfitDefinition KARATE_HEADBAND = new OutfitDefinition(BackMath.backMath("karate_headband"), new OutfitSlot(texture("karate_headband_head")), null, null, null);
    ...
    public static final OutfitDefinition PLATEFORCED_MID_TERM = new OutfitDefinition(BackMath.backMath("plateforced_mid_term"), new OutfitSlot(texture("plateforced_mid_term_head")), new OutfitSlot(texture("plateforced_mid_term_chest"), texture("plateforced_mid_term_chest_emissive")), new OutfitSlot(texture("plateforced_mid_term_legs"), texture("plateforced_mid_term_legs_emissive")), new OutfitSlot(texture("plateforced_mid_term_feet"), texture("plateforced_mid_term_feet_emissive")));
