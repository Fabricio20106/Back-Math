...
public class ClientProxy extends CommonProxy {
    ...
    private void clientSetup(final FMLClientSetupEvent event) {
        ...
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_CRYSTALLINE_BIRCH_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_CRYSTALLINE_BIRCH_WALL_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_GOLDENWOOD_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_GOLDENWOOD_WALL_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_GUAVA_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_GUAVA_WALL_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_JABUTICABA_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_JABUTICABA_WALL_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_CORK_OAK_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_CORK_OAK_WALL_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_AVONDALIC_WILLOW_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_AVONDALIC_WILLOW_WALL_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_HILLARY_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_HILLARY_WALL_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_DEVIL_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_DEVIL_WALL_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_ANGELIC_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_ANGELIC_WALL_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_MID_TERM_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_MID_TERM_WALL_TORCH.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(BMBlocks.CHARJAN_ALJAMEED_TORCH.get(), RenderType.getCutout());
