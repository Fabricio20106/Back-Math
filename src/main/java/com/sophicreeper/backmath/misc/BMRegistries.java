...
public class BMRegistries {
    ...
    public static final IForgeRegistry<QueenLucyVariant> QUEEN_LUCY_VARIANT = new RegistryBuilder<QueenLucyVariant>().setType(QueenLucyVariant.class).setDefaultKey(BackMath.backMath("current")).tagFolder("queen_lucy_variant").setName(BackMath.backMath("queen_lucy_variant")).create();
