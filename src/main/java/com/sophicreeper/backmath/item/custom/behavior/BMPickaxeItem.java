...
public class BMPickaxeItem extends PickaxeItem {
    private final Supplier<ItemBehavior> behavior;

    public BMPickaxeItem(Supplier<ItemBehavior> behavior, IItemTier tier, int attackDamage, float swingSpeed, Properties properties) {
        super(tier, attackDamage, swingSpeed, properties);
        this.behavior = behavior;
    }

    public BMPickaxeItem(IItemTier tier, int attackDamage, float swingSpeed, Properties properties) {
