...
public class BMArmorItem extends ArmorItem {
    ...
    public BMArmorItem(IArmorMaterial material, EquipmentSlotType slotType, Supplier<ItemBehavior> behavior, Properties properties) {
        super(material, slotType, properties);
        this.behavior = behavior;
    }

    public BMArmorItem(IArmorMaterial material, EquipmentSlotType slotType, Properties properties) {
        this(material, slotType, BMItemBehaviors.NONE, properties);
    }
