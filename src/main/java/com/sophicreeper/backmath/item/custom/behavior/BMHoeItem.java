...
public class BMHoeItem extends HoeItem {
    private final Supplier<ItemBehavior> behavior;

    public BMHoeItem(Supplier<ItemBehavior> behavior, IItemTier tier, int attackDamage, float swingSpeed, Properties properties) {
        super(tier, attackDamage, swingSpeed, properties);
        this.behavior = behavior;
    }

    public BMHoeItem(IItemTier tier, int attackDamage, float swingSpeed, Properties properties) {
