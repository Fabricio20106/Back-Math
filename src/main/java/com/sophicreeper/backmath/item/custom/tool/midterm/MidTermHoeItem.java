...
public class MidTermHoeItem extends HoeItem implements MidTermToolBehaviors {
    public MidTermHoeItem(IItemTier tier, int attackDamage, float swingSpeed, Properties properties) {
