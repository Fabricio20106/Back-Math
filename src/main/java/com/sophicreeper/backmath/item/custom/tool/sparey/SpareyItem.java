...
public class SpareyItem extends SwordItem implements ToolBehaviors {
    public SpareyItem(IItemTier tier, int attackDamage, float swingSpeed, Properties properties) {
