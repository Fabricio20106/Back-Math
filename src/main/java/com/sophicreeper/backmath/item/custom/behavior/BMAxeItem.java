...
public class BMAxeItem extends AxeItem {
    private final Supplier<ItemBehavior> behavior;

    public BMAxeItem(Supplier<ItemBehavior> behavior, IItemTier tier, float attackDamage, float swingSpeed, Properties properties) {
        super(tier, attackDamage, swingSpeed, properties);
        this.behavior = behavior;
    }

    public BMAxeItem(IItemTier tier, float attackDamage, float swingSpeed, Properties properties) {
