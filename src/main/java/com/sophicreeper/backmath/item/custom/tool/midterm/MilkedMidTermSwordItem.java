...
public class MilkedMidTermSwordItem extends MilkedSwordItem implements MidTermToolBehaviors {
    public MilkedMidTermSwordItem(IItemTier tier, int attackDamage, float swingSpeed, Properties properties) {
