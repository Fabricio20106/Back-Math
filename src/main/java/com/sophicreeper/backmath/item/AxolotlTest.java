...
public class AxolotlTest {
    ...
    public static final RegistryObject<Item> CRYSTALLINE_BIRCH_GRAPE_VINE_POST = ITEMS.register("crystalline_birch_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.CRYSTALLINE_BIRCH_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> GOLDENWOOD_GRAPE_VINE_POST = ITEMS.register("goldenwood_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.GOLDENWOOD_GRAPE_VINE_POST.get(), new Item.Properties().rarity(Rarity.RARE).group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> GUAVA_GRAPE_VINE_POST = ITEMS.register("guava_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.GUAVA_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> JABUTICABA_GRAPE_VINE_POST = ITEMS.register("jabuticaba_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.JABUTICABA_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> CORK_OAK_GRAPE_VINE_POST = ITEMS.register("cork_oak_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.CORK_OAK_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> ALJANWOOD_GRAPE_VINE_POST = ITEMS.register("aljanwood_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.ALJANWOOD_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> ALJAN_LIGHT_BLUE_STAINED_GLASS = ITEMS.register("aljan_light_blue_stained_glass", () -> new BlockItem(BMBlocks.ALJAN_LIGHT_BLUE_STAINED_GLASS.get(), new Item.Properties().group(BMBlockTab.TAB)));
    public static final RegistryObject<Item> ALJAN_LIGHT_BLUE_STAINED_GLASS_PANE = ITEMS.register("aljan_light_blue_stained_glass_pane", () -> new BlockItem(BMBlocks.ALJAN_LIGHT_BLUE_STAINED_GLASS_PANE.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> ALJANCAP_GRAPE_VINE_POST = ITEMS.register("aljancap_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.ALJANCAP_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> POISON_BROWN_STAINED_GLASS = ITEMS.register("poison_brown_stained_glass", () -> new BlockItem(BMBlocks.POISON_BROWN_STAINED_GLASS.get(), new Item.Properties().group(BMBlockTab.TAB)));
    public static final RegistryObject<Item> POISON_BROWN_STAINED_GLASS_PANE = ITEMS.register("poison_brown_stained_glass_pane", () -> new BlockItem(BMBlocks.POISON_BROWN_STAINED_GLASS_PANE.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> INSOMNIAN_GRAPE_VINE_POST = ITEMS.register("insomnian_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.INSOMNIAN_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> INSOMNIAN_STAINED_GLASS = ITEMS.register("insomnian_stained_glass", () -> new BlockItem(BMBlocks.INSOMNIAN_STAINED_GLASS.get(), new Item.Properties().group(BMBlockTab.TAB)));
    public static final RegistryObject<Item> INSOMNIAN_STAINED_GLASS_PANE = ITEMS.register("insomnian_stained_glass_pane", () -> new BlockItem(BMBlocks.INSOMNIAN_STAINED_GLASS_PANE.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> AVONDALIC_WILLOW_GRAPE_VINE_POST = ITEMS.register("avondalic_willow_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.AVONDALIC_WILLOW_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    // Tabu:
    public static final RegistryObject<Item> TABU = ITEMS.register("tabu", () -> new BlockItem(BMBlocks.TABU.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    // Aljanstone:
    public static final RegistryObject<Item> RAW_ALJAMIC_COPPER_BLOCK = ITEMS.register("raw_aljamic_copper_block", () -> new BlockItem(BMBlocks.RAW_ALJAMIC_COPPER_BLOCK.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> RAW_ALJAMIC_TIN_BLOCK = ITEMS.register("raw_aljamic_tin_block", () -> new BlockItem(BMBlocks.RAW_ALJAMIC_TIN_BLOCK.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> COLDTERM_BLOCK = ITEMS.register("coldterm_block", () -> new BlockItem(BMBlocks.COLDTERM_BLOCK.get(), new Item.Properties().group(BMBlockTab.TAB).isImmuneToFire().rarity(Rarity.RARE)));
    ...
    public static final RegistryObject<Item> WARMTERM_BLOCK = ITEMS.register("warmterm_block", () -> new BlockItem(BMBlocks.WARMTERM_BLOCK.get(), new Item.Properties().group(BMBlockTab.TAB).isImmuneToFire().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> WARMTERM_BRICKS = ITEMS.register("warmterm_bricks", () -> new BlockItem(BMBlocks.WARMTERM_BRICKS.get(), new Item.Properties().group(BMBlockTab.TAB).isImmuneToFire().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> WARMTERM_BRICK_STAIRS = ITEMS.register("warmterm_brick_stairs", () -> new BlockItem(BMBlocks.WARMTERM_BRICK_STAIRS.get(), new Item.Properties().group(BMBlockTab.TAB).isImmuneToFire().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> WARMTERM_BRICK_SLAB = ITEMS.register("warmterm_brick_slab", () -> new BlockItem(BMBlocks.WARMTERM_BRICK_SLAB.get(), new Item.Properties().group(BMBlockTab.TAB).isImmuneToFire().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> WARMTERM_BRICK_WALL = ITEMS.register("warmterm_brick_wall", () -> new BlockItem(BMBlocks.WARMTERM_BRICK_WALL.get(), new Item.Properties().group(BMBlockTab.TAB).isImmuneToFire().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> CHISELED_OBSIDITERM = ITEMS.register("chiseled_obsiditerm", () -> new BlockItem(BMBlocks.CHISELED_OBSIDITERM.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    // Charjan Coal Block:
    public static final RegistryObject<Item> CHARJAN_COAL_BLOCK = ITEMS.register("charjan_coal_block", () -> new FuelBlockItem(4800, BMBlocks.CHARJAN_COAL_BLOCK.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    // Block of Emeriond
    public static final RegistryObject<Item> EMERIOND_BLOCK = ITEMS.register("emeriond_block", () -> new BlockItem(BMBlocks.EMERIOND_BLOCK.get(), new Item.Properties().group(BMBlockTab.TAB).rarity(Rarity.UNCOMMON)));

    // I don't know what to call this blank area.
    public static final RegistryObject<Item> CARAMELED_HAY_BALE = ITEMS.register("carameled_hay_bale", () -> new BlockItem(BMBlocks.CARAMELED_HAY_BALE.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    // Grape Vine Posts:
    public static final RegistryObject<Item> OAK_GRAPE_VINE_POST = ITEMS.register("oak_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.OAK_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    public static final RegistryObject<Item> SPRUCE_GRAPE_VINE_POST = ITEMS.register("spruce_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.SPRUCE_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    public static final RegistryObject<Item> BIRCH_GRAPE_VINE_POST = ITEMS.register("birch_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.BIRCH_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    public static final RegistryObject<Item> JUNGLE_GRAPE_VINE_POST = ITEMS.register("jungle_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.JUNGLE_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    public static final RegistryObject<Item> ACACIA_GRAPE_VINE_POST = ITEMS.register("acacia_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.ACACIA_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    public static final RegistryObject<Item> DARK_OAK_GRAPE_VINE_POST = ITEMS.register("dark_oak_grape_vine_post", () -> new FuelBlockItem(150, BMBlocks.DARK_OAK_GRAPE_VINE_POST.get(), new Item.Properties().group(BMBlockTab.TAB)));
    ...
    public static final RegistryObject<Item> QUEEN_LUCY_HEAD = ITEMS.register("queen_sophie_head", () -> new BMHeadItem(BMBlocks.QUEEN_LUCY_HEAD.get(), BMBlocks.QUEEN_LUCY_WALL_HEAD.get(), new Item.Properties().group(BMBlockTab.TAB).rarity(Rarity.EPIC)));
    ...
    // Back Layer:
    public static final RegistryObject<Item> CHARJAN_COAL = ITEMS.register("charjan_coal", () -> new FuelItem(2400, new Item.Properties().group(BackLayer.TAB)));
    ...
    public static final RegistryObject<Item> MID_TERM = ITEMS.register("mid_term", () -> new MidTermItem(new Item.Properties().isImmuneToFire().rarity(Rarity.RARE).group(BackLayer.TAB)));
    ...
    public static final RegistryObject<Item> MILKLLARITY = ITEMS.register("milkllarity", () -> new CrystallizerMaterialItem(new Item.Properties().group(BackLayer.TAB).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> AMARACAMELARITY = ITEMS.register("amaracamelarity", () -> new Item(new Item.Properties().group(BackLayer.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> YIN_YANG = ITEMS.register("yin_yang", () -> new Item(new Item.Properties().isImmuneToFire().rarity(Rarity.EPIC)));
    ...
    public static final RegistryObject<Item> CRYSTALLINE_ANGELIC = ITEMS.register("crystalline_angelic", () -> new CrystallizerMaterialItem(new Item.Properties().group(BackLayer.TAB).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> CUT_JANTICAL = ITEMS.register("cut_jantical", () -> new Item(new Item.Properties().group(BackLayer.TAB).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> EMERIOND = ITEMS.register("emeriond", () -> new Item(new Item.Properties().group(BackLayer.TAB).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> MILKLLARY_INGOT = ITEMS.register("milkllary_ingot", () -> new CrystallizerMaterialItem(new Item.Properties().group(BackLayer.TAB).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> HARDENED_AMARACAMEL_BATTER = ITEMS.register("hardened_amaracamel_batter", () -> new CrystallizerMaterialItem(new Item.Properties().group(BackLayer.TAB)));
    ...
    public static final RegistryObject<Item> WARMTERM_INGOT = ITEMS.register("warmterm_ingot", () -> new Item(new Item.Properties().group(BackLayer.TAB).isImmuneToFire().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> MID_TERM_INGOT = ITEMS.register("mid_term_ingot", () -> new GlisteringCrystallizerMaterialItem(new Item.Properties().group(BackLayer.TAB).isImmuneToFire().rarity(Rarity.RARE)));
    public static final RegistryObject<Item> COLDTERM_INGOT = ITEMS.register("coldterm_ingot", () -> new Item(new Item.Properties().group(BackLayer.TAB).isImmuneToFire().rarity(Rarity.RARE)));
    public static final RegistryObject<Item> OBSIDIAN_INFUSED_MID_TERM_INGOT = ITEMS.register("obsidian_infused_mid_term_ingot", () -> new GlisteringCrystallizerMaterialItem(new Item.Properties().group(BackLayer.TAB).isImmuneToFire().rarity(Rarity.EPIC)));
    ...
    public static final RegistryObject<Item> HILLARY_BUCKET = ITEMS.register("hilary_bucket", () -> new BMBucketItem(BMFluids.HILLARY, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(BackLayer.TAB)));
    public static final RegistryObject<Item> MILKLLARY_BUCKET = ITEMS.register("milklary_bucket", () -> new BMBucketItem(BMFluids.MILKLLARY, new Item.Properties().containerItem(Items.BUCKET).rarity(Rarity.UNCOMMON).maxStackSize(1).group(BackLayer.TAB)));
    public static final RegistryObject<Item> LIQUID_ALJAME_BUCKET = ITEMS.register("liquid_aljame_bucket", () -> new BMBucketItem(BMFluids.LIQUID_ALJAME, new Item.Properties().containerItem(Items.BUCKET).group(BackLayer.TAB).maxStackSize(1)));
    public static final RegistryObject<Item> LIQUID_MANGA_BUCKET = ITEMS.register("liquid_manga_bucket", () -> new BMBucketItem(BMFluids.LIQUID_MANGA, new Item.Properties().containerItem(Items.BUCKET).group(BackLayer.TAB).maxStackSize(1)));
    public static final RegistryObject<Item> LIQUEFIED_MONSTER_BUCKET = ITEMS.register("liquefied_monster_bucket", () -> new BMBucketItem(BMFluids.LIQUEFIED_MONSTER, new Item.Properties().containerItem(Items.BUCKET).group(BackLayer.TAB).maxStackSize(1)));
    public static final RegistryObject<Item> SLEEPISHWATER_BUCKET = ITEMS.register("sleepishwater_bucket", () -> new BMBucketItem(BMFluids.SLEEPISHWATER, new Item.Properties().containerItem(Items.BUCKET).group(BackLayer.TAB).maxStackSize(1)));
    public static final RegistryObject<Item> MOLTEN_MID_TERM_BUCKET = ITEMS.register("molten_mid_term_bucket", () -> new GlisteringCrystallizerMaterialItem(new Item.Properties().containerItem(Items.BUCKET).rarity(Rarity.RARE).maxStackSize(1).group(BackLayer.TAB)));
    ...
    public static final RegistryObject<Item> HUMAN_PATRICK = ITEMS.register("human_patrick", () -> new GlisteringItem(new Item.Properties().rarity(Rarity.EPIC).maxStackSize(1).isImmuneToFire()));
    ...
    public static final RegistryObject<Item> ALJANCAP_BOAT = ITEMS.register("aljancap_boat", () -> new BMBoatItem(new Item.Properties().maxStackSize(1).group(BackLayer.TAB), "aljancap"));
    public static final RegistryObject<Item> INSOMNIAN_BOAT = ITEMS.register("insomnian_boat", () -> new BMBoatItem(new Item.Properties().maxStackSize(1).group(BackLayer.TAB), "insomnian"));
    public static final RegistryObject<Item> JANTIQUIFIED_PEARL = ITEMS.register("jantiquified_pearl", () -> new JantiquifiedPearlItem(new Item.Properties().rarity(Rarity.UNCOMMON).group(BackLayer.TAB)));
    ...
    public static final RegistryObject<Item> SLEEPISH_FERTILIZER = ITEMS.register("sleepish_fertilizer", () -> new SleepishFertilizerItem(new Item.Properties().group(BackLayer.TAB)));
    ...
    public static final RegistryObject<Item> REGULAR_MOLDS_BOOK = ITEMS.register("regular_molds_book", () -> new MoldsBookItem(new Item.Properties().group(BackLayer.TAB).rarity(Rarity.UNCOMMON).maxStackSize(1)));
    public static final RegistryObject<Item> ADVANCED_MOLDS_BOOK = ITEMS.register("advanced_molds_book", () -> new MoldsBookItem(new Item.Properties().group(BackLayer.TAB).rarity(Rarity.RARE).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> SLEEPISHWATER_BOTTLE = ITEMS.register("sleepishwater_bottle", () -> new SleepishwaterBottleItem(new Item.Properties().maxStackSize(1).group(BackLayer.TAB)));
    ...
    public static final RegistryObject<Item> TWO_THIRDS_HILLARY_DUST = ITEMS.register("two_thirds_hillary_dust", () -> new Item(new Item.Properties().group(BackLayer.TAB).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> EMPTY_MOLD = ITEMS.register("empty_mold", () -> new MoldItem("empty", new Item.Properties().group(BackLayer.TAB)));
    public static final RegistryObject<Item> INGOT_MOLD = ITEMS.register("ingot_mold", () -> new MoldItem("ingot", new Item.Properties().group(BackLayer.TAB).maxStackSize(1)));
    public static final RegistryObject<Item> SINGULARITY_MOLD = ITEMS.register("singularity_mold", () -> new MoldItem("singularity", new Item.Properties().group(BackLayer.TAB).maxStackSize(1)));
    public static final RegistryObject<Item> ROD_MOLD = ITEMS.register("rod_mold", () -> new MoldItem("rod", new Item.Properties().group(BackLayer.TAB).maxStackSize(1)));
    public static final RegistryObject<Item> MOLD_MOLD = ITEMS.register("mold_mold", () -> new MoldItem("mold", new Item.Properties().group(BackLayer.TAB).maxStackSize(1)));
    public static final RegistryObject<Item> CRYSTALLIZED_MOLD = ITEMS.register("crystallized_mold", () -> new MoldItem("crystallized", new Item.Properties().group(BackLayer.TAB).maxStackSize(1)));
    public static final RegistryObject<Item> CRYSTALLINE_EMPTY_MOLD = ITEMS.register("crystalline_empty_mold", () -> new MoldItem("crystalline_empty", new Item.Properties().group(BackLayer.TAB)));
    public static final RegistryObject<Item> CRYSTALLINE_GEM_MOLD = ITEMS.register("crystalline_gem_mold", () -> new MoldItem("crystalline_gem", new Item.Properties().group(BackLayer.TAB).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> HARDENED_AMARACAMEL_WARRIOR_HELMET = ITEMS.register("hardened_amaracamel_warrior_helmet", () -> new BMArmorItem(WARRIOR_HARDENED_AMARACAMEL_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> HARDENED_AMARACAMEL_HELMET = ITEMS.register("hardened_amaracamel_helmet", () -> new BMArmorItem(HARDENED_AMARACAMEL_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> HARDENED_AMARACAMEL_CHESTPLATE = ITEMS.register("hardened_amaracamel_chestplate", () -> new BMArmorItem(HARDENED_AMARACAMEL_ARMOR, EquipmentSlotType.CHEST, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> HARDENED_AMARACAMEL_LEGGINGS = ITEMS.register("hardened_amaracamel_leggings", () -> new BMArmorItem(HARDENED_AMARACAMEL_ARMOR, EquipmentSlotType.LEGS, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> HARDENED_AMARACAMEL_BOOTS = ITEMS.register("hardened_amaracamel_boots", () -> new BMArmorItem(HARDENED_AMARACAMEL_ARMOR, EquipmentSlotType.FEET, new Item.Properties().group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> OBSIDIAN_INFUSED_MID_TERM_WARRIOR_HELMET = ITEMS.register("obsidian_infused_mid_term_warrior_helmet", () -> new GlisteringArmorItem(WARRIOR_OBSIDIAN_INFUSED_MID_TERM_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB).isImmuneToFire().rarity(Rarity.EPIC)));
    ...
    public static final RegistryObject<Item> MILKLLARY_WARRIOR_HELMET = ITEMS.register("milkllary_warrior_helmet", () -> new BMArmorItem(WARRIOR_MILKLLARY_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> MILKLLARY_HELMET = ITEMS.register("milkllary_helmet", () -> new BMArmorItem(MILKLLARY_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> MILKLLARY_CHESTPLATE = ITEMS.register("milkllary_chestplate", () -> new BMArmorItem(MILKLLARY_ARMOR, EquipmentSlotType.CHEST, new Item.Properties().group(BMWeaponryTab.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> MILKLLARY_LEGGINGS = ITEMS.register("milkllary_leggings", () -> new BMArmorItem(MILKLLARY_ARMOR, EquipmentSlotType.LEGS, new Item.Properties().group(BMWeaponryTab.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> MILKLLARY_BOOTS = ITEMS.register("milkllary_boots", () -> new BMArmorItem(MILKLLARY_ARMOR, EquipmentSlotType.FEET, new Item.Properties().group(BMWeaponryTab.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> JANTSKIN_HELMET = ITEMS.register("jantskin_helmet", () -> new BMArmorItem(JANTSKIN_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> JANTSKIN_CHESTPLATE = ITEMS.register("jantskin_chestplate", () -> new BMArmorItem(JANTSKIN_ARMOR, EquipmentSlotType.CHEST, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> JANTSKIN_LEGGINGS = ITEMS.register("jantskin_leggings", () -> new BMArmorItem(JANTSKIN_ARMOR, EquipmentSlotType.LEGS, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> JANTSKIN_BOOTS = ITEMS.register("jantskin_boots", () -> new BMArmorItem(JANTSKIN_ARMOR, EquipmentSlotType.FEET, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> ALJAMEED_WARRIOR_HELMET = ITEMS.register("aljameed_warrior_helmet", () -> new BMArmorItem(WARRIOR_ALJAMEED_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> ALJAMEED_HELMET = ITEMS.register("aljameed_helmet", () -> new BMArmorItem(ALJAMEED_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> ALJAMEED_CHESTPLATE = ITEMS.register("aljameed_chestplate", () -> new BMArmorItem(ALJAMEED_ARMOR, EquipmentSlotType.CHEST, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> ALJAMEED_LEGGINGS = ITEMS.register("aljameed_leggings", () -> new BMArmorItem(ALJAMEED_ARMOR, EquipmentSlotType.LEGS, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> ALJAMEED_BOOTS = ITEMS.register("aljameed_boots", () -> new BMArmorItem(ALJAMEED_ARMOR, EquipmentSlotType.FEET, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MOONERING_WARRIOR_HELMET = ITEMS.register("moonering_warrior_helmet", () -> new BMArmorItem(WARRIOR_MOONERING_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MOONERING_HELMET = ITEMS.register("moonering_helmet", () -> new BMArmorItem(MOONERING_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MOONERING_CHESTPLATE = ITEMS.register("moonering_chestplate", () -> new BMArmorItem(MOONERING_ARMOR, EquipmentSlotType.CHEST, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MOONERING_LEGGINGS = ITEMS.register("moonering_leggings", () -> new BMArmorItem(MOONERING_ARMOR, EquipmentSlotType.LEGS, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MOONERING_BOOTS = ITEMS.register("moonering_boots", () -> new BMArmorItem(MOONERING_ARMOR, EquipmentSlotType.FEET, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> JANTIQUIFIED_MOONERING_WARRIOR_HELMET = ITEMS.register("jantiquified_moonering_warrior_helmet", () -> new BMArmorItem(WARRIOR_JANTIQUIFIED_MOONERING_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> JANTIQUIFIED_MOONERING_HELMET = ITEMS.register("jantiquified_moonering_helmet", () -> new BMArmorItem(JANTIQUIFIED_MOONERING_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> JANTIQUIFIED_MOONERING_CHESTPLATE = ITEMS.register("jantiquified_moonering_chestplate", () -> new BMArmorItem(JANTIQUIFIED_MOONERING_ARMOR, EquipmentSlotType.CHEST, new Item.Properties().rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> JANTIQUIFIED_MOONERING_LEGGINGS = ITEMS.register("jantiquified_moonering_leggings", () -> new BMArmorItem(JANTIQUIFIED_MOONERING_ARMOR, EquipmentSlotType.LEGS, new Item.Properties().rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> JANTIQUIFIED_MOONERING_BOOTS = ITEMS.register("jantiquified_moonering_boots", () -> new BMArmorItem(JANTIQUIFIED_MOONERING_ARMOR, EquipmentSlotType.FEET, new Item.Properties().rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> CANDY_YELLOW_TURTLE_HELMET = ITEMS.register("candy_yellow_turtle_helmet", () -> new TurtleShellItem(CANDY_YELLOW_TURTLE_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> CANDY_PINK_TURTLE_HELMET = ITEMS.register("candy_pink_turtle_helmet", () -> new TurtleShellItem(CANDY_PINK_TURTLE_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> RED_YELLOW_GLASSES = ITEMS.register("red_yellow_glasses", () -> new BMArmorItem(RED_YELLOW_GLASSES_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> MID_TERM_GREATSWORD = ITEMS.register("mid_term_greatsword", () -> new MidTermGreatswordItem(MID_TERM_SET, 12, -3.4F, new Item.Properties().isImmuneToFire().rarity(Rarity.EPIC).group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> MILKED_PERSONA_BLADE = ITEMS.register("milked_persona_blade", () -> new MilkedSwordItem(PERSONA_SWORD_SET, 0, -2.4F, new Item.Properties().group(BMWeaponryTab.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> MILKED_MID_TERM_SPAREY = ITEMS.register("milked_mid_term_sparey", () -> new MilkedCustomSpareySwordItem(MID_TERM_SPAREY_SET, 3, -2.4F, new Item.Properties().rarity(Rarity.RARE).isImmuneToFire().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MILKED_OBSIDIAN_INFUSED_MID_TERM_SPAREY = ITEMS.register("milked_obsidian_infused_mid_term_sparey", () -> new MilkedCustomSpareySwordItem(OBSIDIAN_INFUSED_MID_TERM_SPAREY_SET, 3, -2.4F, new Item.Properties().rarity(Rarity.EPIC).isImmuneToFire().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MILKED_SPAREY = ITEMS.register("milked_sparey", () -> new MilkedSpareySwordItem(BMSetFields.SPAREY_SET, 3, -2.4F, new Item.Properties().isImmuneToFire().rarity(Rarity.RARE).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MILKED_DEVIL_SPAREY = ITEMS.register("milked_devil_sparey", () -> new MilkedDevilSpareySwordItem(BMSetFields.DEVIL_SPAREY_SET, 3, -2.4F, new Item.Properties().rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MILKED_GOLDEN_PATTY = ITEMS.register("milked_empada_de_ouro", () -> new MilkedSwordItem(GOLDEN_PATTY_SET, 3, -2.4F, new Item.Properties().food(Foods.GOLDEN_APPLE).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MILKED_BUTTER_SWORD = ITEMS.register("milked_espada_de_manteiga", () -> new MilkedButterSwordItem(BUTTER_SWORD_SET, 3, -2.4F, new Item.Properties().food(Foods.BAKED_POTATO).group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> ANGELIC_SPOON = ITEMS.register("spoon", () -> new AngelicSpoonItem(ANGELIC_SET, 1.5F, -3, new Item.Properties().group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> SPAREY = ITEMS.register("sparey", () -> new SpareySwordItem(BMSetFields.SPAREY_SET, 3, -2.4F, new Item.Properties().isImmuneToFire().rarity(Rarity.RARE).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> STACKS = ITEMS.register("stacks", () -> new StacksPickaxeItem(BMSetFields.SPAREY_SET, 1, -2.8F, new Item.Properties().isImmuneToFire().rarity(Rarity.RARE).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> SPAXE = ITEMS.register("spaxe", () -> new SpaxeAxeItem(BMSetFields.SPAREY_SET, 6, -3.1F, new Item.Properties().isImmuneToFire().rarity(Rarity.RARE).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> SPAVEL = ITEMS.register("spavel", () -> new SpavelShovelItem(BMSetFields.SPAREY_SET, 1.5F, -3, new Item.Properties().isImmuneToFire().rarity(Rarity.RARE).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> STOE = ITEMS.register("stoe", () -> new StoeHoeItem(BMSetFields.SPAREY_SET, -2, -1, new Item.Properties().isImmuneToFire().rarity(Rarity.RARE).group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> MID_TERM_KNIFE = ITEMS.register("mid_term_knife", () -> new MidTermKnifeItem(2, -1.6F, MID_TERM_SET, new Item.Properties().isImmuneToFire().rarity(Rarity.RARE).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> OBSIDIAN_INFUSED_MID_TERM_KNIFE = ITEMS.register("obsidian_infused_mid_term_knife", () -> new MidTermKnifeItem(2, -1.6F, OBSIDIAN_INFUSED_MID_TERM_SET, new Item.Properties().isImmuneToFire().rarity(Rarity.EPIC).group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> TABU_SWORD = ITEMS.register("tabu_sword", () -> new SwordItem(TABU_SWORD_SET, 2, -1.6F, new Item.Properties().rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> BREAD_SWORD = ITEMS.register("bread_sword", () -> new SwordItem(BREAD_SWORD_SET, 2, -1.6F, new Item.Properties().food(Foods.BREAD).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> PERSONA_BLADE = ITEMS.register("persona_blade", () -> new SwordItem(PERSONA_SWORD_SET, 0, -2.4F, new Item.Properties().group(BMWeaponryTab.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> CAREWNI = ITEMS.register("carewni", () -> new SwordItem(CAREWNI_SET, 0, -2.4F, new Item.Properties().group(BMWeaponryTab.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> GOLDEN_PATTY = ITEMS.register("empada_de_ouro", () -> new SwordItem(GOLDEN_PATTY_SET, 3, -2.4F, new Item.Properties().food(Foods.GOLDEN_APPLE).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> BUTTER_SWORD = ITEMS.register("espada_de_manteiga", () -> new ButterSwordItem(BUTTER_SWORD_SET, 3, -2.4F, new Item.Properties().food(Foods.BAKED_POTATO).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MECH_MECH = ITEMS.register("mech_mech", () -> new MechMechSwordItem(BMSetFields.MECH_MECH_SET, 9, 2, new Item.Properties().rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> DEVIL_SPAREY = ITEMS.register("devil_sparey", () -> new DevilSpareySwordItem(BMSetFields.DEVIL_SPAREY_SET, 3, -2.4F, new Item.Properties().rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MID_TERM_SPAREY = ITEMS.register("mid_term_sparey", () -> new MidTermSpareySwordItem(MID_TERM_SPAREY_SET, 3, -2.4F, new Item.Properties().rarity(Rarity.RARE).isImmuneToFire().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> OBSIDIAN_INFUSED_MID_TERM_SPAREY = ITEMS.register("obsidian_infused_mid_term_sparey", () -> new MidTermSpareySwordItem(OBSIDIAN_INFUSED_MID_TERM_SPAREY_SET, 3, -2.4F, new Item.Properties().rarity(Rarity.EPIC).isImmuneToFire().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> RAINBOW_PENCIL = ITEMS.register("lapis_rainbow", () -> new SwordItem(RAINBOW_PENCIL_SET, 1, -2.4F, new Item.Properties().food(Foods.APPLE).group(BMWeaponryTab.TAB))); // It used to place down Lava.
    public static final RegistryObject<Item> KARATE_TRAINING_STICK = ITEMS.register("karate_training_stick", () -> new SwordItem(KARATE_TRAINING_STICK_SET, 0, -2.4F, new Item.Properties().group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> QUEEN_LUCY_SUMMONER_STAFF = ITEMS.register("queen_sophie_summoner_staff", () -> new QueenLucySummonerStaffItem(BMEntities.QUEEN_LUCY_PET, 0xFFFFFF, 0xFFFFFF, new Item.Properties().group(BMWeaponryTab.TAB).rarity(Rarity.EPIC).maxStackSize(1).isImmuneToFire()));
    public static final RegistryObject<Item> WATER_TALC_POWDER = ITEMS.register("talco_de_agua", () -> new WaterTalcPowderItem(WATER_TALC_POWDER_SET, 0, -2.4F, new Item.Properties().food(BMFoods.WATER_TALCUM_POWDER).group(BMWeaponryTab.TAB).maxStackSize(1)));
    public static final RegistryObject<Item> INSOFLINT_AND_ALJANSTEEL = ITEMS.register("aljamic_flint_and_aljansteel", () -> new InsoflintAndAljansteelItem(new Item.Properties().maxDamage(250).group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> DEVIL_CROSSBOW = ITEMS.register("devil_crossbow", () -> new BMCrossbowItem(true, new Item.Properties().maxDamage(520).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> ANGELIC_CROSSBOW = ITEMS.register("angelic_crossbow", () -> new BMCrossbowItem(false, new Item.Properties().maxDamage(520).group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> SUPERHEATER = ITEMS.register("superheater", () -> new DamageableCraftingToolItem(new Item.Properties().maxDamage(2031).rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> MORTAR_AND_PESTLE = ITEMS.register("mortar_and_pestle", () -> new DamageableCraftingToolItem(new Item.Properties().maxDamage(384).group(BMWeaponryTab.TAB)));
    public static final RegistryObject<Item> CRYSTALLINE_BIRCH_MORTAR_AND_PESTLE = ITEMS.register("crystalline_birch_mortar_and_pestle", () -> new DamageableCraftingToolItem(new Item.Properties().maxDamage(384).group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> AVONDALIC_WILLOW_MORTAR_AND_PESTLE = ITEMS.register("avondalic_willow_mortar_and_pestle", () -> new DamageableCraftingToolItem(new Item.Properties().maxDamage(384).group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> OBSIDIAN_INFUSED_MID_TERM_SHEARS = ITEMS.register("obsidian_infused_mid_term_shears", () -> new MidTermShearsItem(new Item.Properties().isImmuneToFire().group(BMWeaponryTab.TAB).rarity(Rarity.EPIC).maxDamage(4062)));
    ...
    public static final RegistryObject<Item> MID_TERM_SHIELD = ITEMS.register("mid_term_shield", () -> new MidTermShieldItem(new Item.Properties().rarity(Rarity.RARE).isImmuneToFire().maxStackSize(1).maxDamage(4062).group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> ALJAME = ITEMS.register("aljame", () -> new CrystallizerMaterialItem(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.ALJAME)));
    ...
    public static final RegistryObject<Item> SPICE_POT = ITEMS.register("spice_pot", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB)));
    public static final RegistryObject<Item> OREGANO_POT = ITEMS.register("oregano_pot", () -> new JamItem(new Item.Properties().containerItem(AxolotlTest.SPICE_POT.get()).group(SophiesCursedFoods.TAB)));
    ...
    public static final RegistryObject<Item> EFFECT_JAM = ITEMS.register("effect_jam", () -> new EffectJamItem(new Item.Properties().maxStackSize(1).containerItem(AxolotlTest.JAM_POT.get()).group(SophiesCursedFoods.TAB)));
    ...
    public static final RegistryObject<Item> WATER_DROPLET_BREAD = ITEMS.register("water_droplet_bread", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.WATER_JAM_BREAD)));
    public static final RegistryObject<Item> ZE_DROPLET_BREAD = ITEMS.register("ze_droplet_bread", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.WATER_JAM_BREAD)));
    public static final RegistryObject<Item> HILLARY_JAM_BREAD = ITEMS.register("hilary_jam_bread", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.HILLARY_JAM_BREAD)));
    public static final RegistryObject<Item> MILKLLARY_JAM_BREAD = ITEMS.register("milklary_jam_bread", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.MILKLLARY_JAM_BREAD)));
    ...
    public static final RegistryObject<Item> SWEET_BERRY_JAM_BREAD = ITEMS.register("sweet_berry_jam_bread", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.BERRY_JAM_BREAD)));
    public static final RegistryObject<Item> GLOW_BERRY_JAM_BREAD = ITEMS.register("glow_berry_jam_bread", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.BERRY_JAM_BREAD)));
    public static final RegistryObject<Item> FRIED_EGG_BREAD = ITEMS.register("fried_egg_bread", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.FRIED_EGG_BREAD)));
    public static final RegistryObject<Item> TURTLE_FRIED_EGG_BREAD = ITEMS.register("turtle_fried_egg_bread", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.FRIED_EGG_BREAD)));
    public static final RegistryObject<Item> ENDER_DRAGON_FRIED_EGG_BREAD = ITEMS.register("ender_dragon_fried_egg_bread", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.FRIED_EGG_BREAD)));
    public static final RegistryObject<Item> BREAD_WITH_PAO = ITEMS.register("bread_with_pao", () -> new DescriptiveItem(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.BREAD_WITH_PAO)));
    ...
    public static final RegistryObject<Item> MONSTER_ENERGY_DRINK = ITEMS.register("monster_energy_drink", () -> new BottleDrinkItem(new Item.Properties().maxStackSize(1).group(SophiesCursedFoods.TAB)));
    public static final RegistryObject<Item> ENERGETIC_MONSTER = ITEMS.register("energetic_monster", () -> new BottleDrinkItem(new Item.Properties().maxStackSize(1).group(SophiesCursedFoods.TAB)));
    public static final RegistryObject<Item> WINE = ITEMS.register("wine", () -> new WineItem(new Item.Properties().maxStackSize(1).group(SophiesCursedFoods.TAB)));
    public static final RegistryObject<Item> JABUTICABA_WINE = ITEMS.register("jabuticaba_wine", () -> new WineItem(new Item.Properties().maxStackSize(1).group(SophiesCursedFoods.TAB)));
    ...
    public static final RegistryObject<Item> ALJAME_TEA = ITEMS.register("aljame_tea", () -> new MealCookerIngredientItem(new Item.Properties().group(SophiesCursedFoods.TAB)));
    ...
    public static final RegistryObject<Item> COFFEE_MUG = ITEMS.register("coffee_mug", () -> new BucketDrinkItem(new Item.Properties().maxStackSize(1).group(SophiesCursedFoods.TAB)));
    public static final RegistryObject<Item> CHOCCY_MILK_BUCKET = ITEMS.register("choccy_milk_bucket", () -> new RegularDrinkItem(new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).food(BMFoods.CHOCCY_MILK_BUCKET).group(SophiesCursedFoods.TAB)));
    public static final RegistryObject<Item> CHOCCY_MILK_BOTTLE = ITEMS.register("choccy_milk_bottle", () -> new RegularDrinkItem(new Item.Properties().containerItem(Items.GLASS_BOTTLE).maxStackSize(8).food(BMFoods.CHOCCY_MILK_BOTTLE).group(SophiesCursedFoods.TAB)));
    ...
    public static final RegistryObject<Item> MILKLLARY_BOTTLE = ITEMS.register("milkllary_bottle", () -> new BottleDrinkAltItem(new Item.Properties().containerItem(Items.GLASS_BOTTLE).rarity(Rarity.UNCOMMON).group(SophiesCursedFoods.TAB)));
    public static final RegistryObject<Item> TODDY = ITEMS.register("toddy", () -> new ToddyItem(new Item.Properties().group(SophiesCursedFoods.TAB).maxStackSize(1).food(BMFoods.TODDY)));
    ...
    public static final RegistryObject<Item> RAW_MINCED_SOPHIE = ITEMS.register("raw_minced_sophie", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.RAW_MINCED_MEAT)));
    ...
    public static final RegistryObject<Item> MINCED_SOPHIE = ITEMS.register("minced_sophie", () -> new DescriptiveItem(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.COOKED_MINCED_MEAT)));
    ...
    public static final RegistryObject<Item> RAW_MINCED_LUCIA = ITEMS.register("raw_minced_lucia", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.RAW_MINCED_MEAT)));
    ...
    public static final RegistryObject<Item> MINCED_LUCIA = ITEMS.register("minced_lucia", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.COOKED_MINCED_MEAT)));
    ...
    public static final RegistryObject<Item> RAW_MINCED_FABRICIO = ITEMS.register("raw_minced_fabricio", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.RAW_MINCED_MEAT)));
    ...
    public static final RegistryObject<Item> MINCED_FABRICIO = ITEMS.register("minced_fabricio", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(BMFoods.COOKED_MINCED_MEAT)));
    ...
    public static final RegistryObject<Item> HOT_SOPHIE_COLD_FABRICIO_MEAL = ITEMS.register("hot_sophie_cold_fabricio_meal", () -> new HotSophieAndColdFabricioMealItem(new Item.Properties().group(SophiesCursedFoods.TAB).maxStackSize(8).rarity(Rarity.UNCOMMON).food(BMFoods.HOT_SOPHIE_AND_COLD_FABRICIO_MEAL)));
    public static final RegistryObject<Item> AMARACAMEL_BATTER_BAG = ITEMS.register("amaracamel_batter_bag", () -> new PlaceableBagItem(BMBlocks.AMARACAMEL_BATTER_BAG.get(), new Item.Properties().group(SophiesCursedFoods.TAB)));
    ...
    public static final RegistryObject<Item> BOOT_PACK = ITEMS.register("boot_pack", () -> new PlaceableBagItem(BMBlocks.BOOT_PACK.get(), new Item.Properties().group(SophiesCursedFoods.TAB)));
    ...
    public static final RegistryObject<Item> OREGANO_FRIED_EGG = ITEMS.register("oregano_fried_egg", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(Foods.BAKED_POTATO)));
    ...
    public static final RegistryObject<Item> OREGANO_TURTLE_FRIED_EGG = ITEMS.register("oregano_turtle_fried_egg", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(Foods.BAKED_POTATO)));
    ...
    public static final RegistryObject<Item> OREGANO_ENDER_DRAGON_FRIED_EGG = ITEMS.register("oregano_ender_dragon_fried_egg", () -> new Item(new Item.Properties().group(SophiesCursedFoods.TAB).food(Foods.BAKED_POTATO)));
