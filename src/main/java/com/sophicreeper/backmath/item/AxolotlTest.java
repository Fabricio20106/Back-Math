...
public class AxolotlTest {
    ...
    public static final RegistryObject<Item> CUT_JANTICAL = ITEMS.register("cut_jantical", () -> new JanticalItem(new Item.Properties().group(BackLayer.TAB).rarity(Rarity.UNCOMMON)));
