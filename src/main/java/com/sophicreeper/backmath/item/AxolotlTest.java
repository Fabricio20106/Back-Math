...
public class AxolotlTest {
    ...
    public static final RegistryObject<Item> ALJAMEED_WARRIOR_HELMET = ITEMS.register("aljameed_warrior_helmet", () -> new BMArmorItem(WARRIOR_ALJAMEED_ARMOR, EquipmentSlotType.HEAD, new Item.Properties().group(BMWeaponryTab.TAB).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> MECH_MECH = ITEMS.register("mech_mech", () -> new MechMechSwordItem(BMSetFields.MECH_MECH_SWORD, 9, 2, new Item.Properties().rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> RAINBOW_PENCIL = ITEMS.register("lapis_rainbow", () -> new SwordItem(RAINBOW_SET, 1, -2.4F, new Item.Properties().food(Foods.APPLE).group(BMWeaponryTab.TAB))); // It used to place down Lava.
    ...
    public static final RegistryObject<Item> WATER_TALC_POWDER = ITEMS.register("talco_de_agua", () -> new WaterTalcPowderItem(TALC_SET, 0, -2.4F, new Item.Properties().food(BMFoods.WATER_TALCUM_POWDER).group(BMWeaponryTab.TAB).maxStackSize(1)));
