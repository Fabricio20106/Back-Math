...
public class AxolotlTest {
    ...
    public static final RegistryObject<Item> MILKED_DEVIL_SPAREY = ITEMS.register("milked_devil_sparey", () -> new MilkedDevilSpareySwordItem(BMSetFields.SPAREY_SET, 3, -2.4F, new Item.Properties().rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
    ...
    public static final RegistryObject<Item> DEVIL_SPAREY = ITEMS.register("devil_sparey", () -> new DevilSpareySwordItem(BMSetFields.SPAREY_SET, 3, -2.4F, new Item.Properties().rarity(Rarity.UNCOMMON).group(BMWeaponryTab.TAB)));
