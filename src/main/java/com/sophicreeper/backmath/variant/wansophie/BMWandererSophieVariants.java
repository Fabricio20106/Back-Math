...
public class BMWandererSophieVariants {
    ...
    public static final RegistryObject<WandererSophieVariant> SAVANNAH = VARIANTS.register("savannah", () -> new WandererSophieVariant(backMath("savannah"), backMath("entity/sophie/wanderer/savannah"), backMath("entity/sophie/wanderer/savannah_emissive"), true, true));
    ...
    public static final RegistryObject<WandererSophieVariant> ENDER = VARIANTS.register("ender", () -> new WandererSophieVariant(backMath("ender"), backMath("entity/sophie/wanderer/ender"), backMath("entity/sophie/wanderer/ender_emissive"), true, true));
    ...
    public static final RegistryObject<WandererSophieVariant> EMPRESARY2 = VARIANTS.register("empresary2", () -> new WandererSophieVariant(backMath("empresary2"), backMath("entity/sophie/wanderer/empresary2"), backMath("entity/sophie/wanderer/empresary2_emissive"), true, true));
    public static final RegistryObject<WandererSophieVariant> ENTREPRENEUR = VARIANTS.register("entrepreneur", () -> new WandererSophieVariant(backMath("entrepreneur"), backMath("entity/sophie/wanderer/entrepreneur"), backMath("entity/sophie/wanderer/entrepreneur_emissive"), true, true));
    ...
    public static final RegistryObject<WandererSophieVariant> PIGLIN_BRUTE = VARIANTS.register("piglin_brute", () -> new WandererSophieVariant(backMath("piglin_brute"), backMath("entity/sophie/wanderer/piglin_brute"), true));
