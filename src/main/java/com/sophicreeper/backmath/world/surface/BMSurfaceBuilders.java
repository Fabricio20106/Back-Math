...
public class BMSurfaceBuilders {
    ...
    public static final ConfiguredSurfaceBuilder<SurfaceBuilderConfig> AVONDALIC = register("avondalic", SurfaceBuilder.DEFAULT.func_242929_a(AVONDALIC_NYLIUM_CONFIG));
