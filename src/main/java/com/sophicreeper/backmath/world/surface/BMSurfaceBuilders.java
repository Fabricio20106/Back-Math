...
public class BMSurfaceBuilders {
    public static final BlockState ALJAMIC_GRASS = BMBlocks.ALJAMIC_GRASS_BLOCK.get().defaultBlockState();
    public static final BlockState AVONDALIC_NYLIUM = BMBlocks.AVONDALIC_NYLIUM.get().defaultBlockState();
    public static final BlockState ALJAMIC_DIRT = BMBlocks.ALJAMIC_DIRT.get().defaultBlockState();
    ...
    public static final ConfiguredSurfaceBuilder<SurfaceBuilderConfig> ALJAN = register("the_aljan", SurfaceBuilder.DEFAULT.configured(ALJAMIC_GRASS_CONFIG));
