...
public class BMConfiguredFeatures {
   ...
   // TODO: BACK MATH 1.7.0: ALJAMIC WARS WORLD GENERATION BELOW
    ...
    public static final ConfiguredFeature<?, ?> TABU_BLOB = register("tabu_blob", Feature.ORE.withConfiguration(
            new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, BMBlocks.TABU.get().getDefaultState(), 23)).range(80).square().func_242731_b(10));
