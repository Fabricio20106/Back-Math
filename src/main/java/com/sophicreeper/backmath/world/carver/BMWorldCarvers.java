...
import com.sophicreeper.backmath.world.carver.custom.AljanLargeCaveCarver;
...
public class BMWorldCarvers {
    ...
    public static final RegistryObject<WorldCarver<ProbabilityConfig>> ALJAN_LARGE_CAVE = WORLD_CARVERS.register("aljan_large_cave", () -> new AljanLargeCaveCarver(ProbabilityConfig.CODEC));
