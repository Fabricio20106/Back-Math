    ...
    public boolean place(ISeedReader reader, ChunkGenerator generator, Random rand, BlockPos pos, NoFeatureConfig config) {
        ...
        if (j2 >= 1 && j2 <= 5) {
                    ...
                    for(int k4 = l1; k4 <= i2; ++k4) {
                        ...
                        if (k3 != k && i4 != -1 && k4 != l1 && k3 != l && i4 != 4 && k4 != i2) {
                            ...
                            if (i4 == -1 && rand.nextInt(4) != 0) {
                                reader.setBlock(pos1, BMBlocks.COBBLED_ALJANSTONE.get().defaultBlockState(), 2);
                            } else {
                                reader.setBlock(pos1, BMBlocks.ALJANSTONE_BRICKS.get().defaultBlockState(), 2);
                            }
                        }
                    }
                }
            ...
            if (spawner instanceof MobSpawnerTileEntity) {
                ((MobSpawnerTileEntity) spawner).getSpawner().setEntityId(SPAWNER_ENTITIES[rand.nextInt(SPAWNER_ENTITIES.length)]);
            } else {
