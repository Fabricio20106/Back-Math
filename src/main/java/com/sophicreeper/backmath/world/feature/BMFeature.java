...
public class BMFeature {
    ...
    public static final RegistryObject<Feature<NoFeatureConfig>> ANGER_DUNGEON = FEATURES.register("anger_dungeon", () -> new AngerDungeonFeature(NoFeatureConfig.CODEC));
}
